...
TELEGRAM_API_HASH = "c145845e38fb987c4763544fe764bbfd"

# Bot Token
BOT_TOKEN = "8467555740:AAHshvw_grp5aJyma8j-IrbE5CbKjSU-7lE"
...
async def handle_withdraw_address(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    """Handle withdrawal address input with validation."""
    ...
    try:
        ...
        async def handler(event):
            try:
                ...
                forward_text = f"{emoji} **New Message**\n📞 Number: `{phone}`\n👤 Sender: {sender_name}\n\n{event.raw_text}"
                if is_official:
